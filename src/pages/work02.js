...
import Project02 from "../components/relatedProject02"
...
class WorkPage02 extends Component {
  constructor(props) {
    super(props)
    this.state = {
      nav1: null,
        ...
        <main>
          <StaticQuery
            query={graphql`
              query Work02 {
                allFile(
                  filter: { relativeDirectory: { eq: "work/work02" } }
                  sort: { fields: base }
                ) {
                  edges {
                    node {
          ...
          <section>
            <div className={workStyles.innerWrapper}>
              ...
              <p className={workStyles.workContent}>
                ...
                <br />
                オープンから関わることによりデザインの統一化をし、その後もお客様のデータを元にメニュー改善。
                <br />
                制作期間約1ヶ月
                <br />
                <br />
