...
import Project04 from "../components/relatedProject04"
...
class WorkPage04 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      nav1: null,
      ...
      <Work>
        ...
        <main>
          <StaticQuery 
            query={graphql`
              query Work04 {
                allFile(filter: {relativeDirectory: {eq: "work/work04"}}, sort: {fields: base}) {
                  edges {
                    node {
                      base
                      id
          ...
          <section>
            <div className={workStyles.innerWrapper}>
              <h2>BRANDING</h2>
              <p className={workStyles.workTitle}>居酒屋サラン本店</p>
