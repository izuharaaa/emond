      ...
      <Work>
        ...
        <main>
          <StaticQuery 
            query={graphql`
              query Work06 {
                allFile(filter: {relativeDirectory: {eq: "work/work06"}}, sort: {fields: base}) {
                  edges {
                    node {
                      base
                      id
          ...
          <section>
            <div className={workStyles.innerWrapper}>
              ...
              <p className={workStyles.workContent}>メニュ制作ー改善。<br />もともと、メニューがなくママさんのオリジナリ理から基本メニューを作成。<br />A4にまとめました。<br />制作期間約1週間<br /><br />Signs, menus, exterior signs, posters, leaflets<br />We have unified the design by being involved since the opening, and have continued to improve the menu based on customer data.<br />Production period about 1 month</p>
            </div>
          </section>
          <Project06 />
        </main>
