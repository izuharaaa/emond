...
import Project08 from "../components/relatedProject08"
...
class WorkPage08 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      nav1: null,
      ...
      <Work>
        ...
        <main>
          <StaticQuery 
            query={graphql`
              query Work08 {
                allFile(filter: {relativeDirectory: {eq: "work/work08"}}, sort: {fields: base}) {
                  edges {
                    node {
                      base
                      id
          ...
          <section>
            <div className={workStyles.innerWrapper}>
              <h2>BRANDING</h2>
              <p className={workStyles.workTitle}>BE BROW</p>
              <p className={workStyles.workContent}>ロゴ制作、名刺制作、ショップカード制作。<br />新規立ち上げに携わり、ヒアリングから開始。<br />制作期間約2週間<br /><br />Signs, menus, exterior signs, posters, leaflets<br />We have unified the design by being involved since the opening, and have continued to improve the menu based on customer data.<br />Production period about 1 month</p>
            </div>
          </section>
          <Project08 />
        </main>
